...
The support directory is `~/Library/Group Containers/G69SCX94XU.duck/Library/Application Support/duck/` on Mac. You can install third party [profiles](../protocol/profiles) in `~/Library/Group Containers/G69SCX94XU.duck/Library/Application Support/duck/Profiles`.
...
The support directory is `~/.duck/` on Linux. You can install third party [profiles](../protocol/profiles) in `~/.duck/profiles/`.
