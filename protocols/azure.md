...
- [Download](http://profiles.cyberduck.io.s3.amazonaws.com/Azure%20(Shared%20Access%20Signature%20Token).cyberduckprofile) the Azure (Shared Access Signature Token) profile or install it from *Preferences… → Profiles*.
