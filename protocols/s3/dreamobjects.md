...
- `us-east-1` {download}`Download<https://github.com/iterate-ch/cyberduck/raw/master/profiles/DreamObjects%20(us-east-1).cyberduckprofile>` the *DreamObjects Cloud Storage Connection Profile* or install it through the *Profiles* tab of the preferences for preconfigured settings. 
