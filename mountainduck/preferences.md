...
:class: tip
The mount location **cannot** be set to `/Volumes` where the directory is not writable. The default is set to `~/Library/Group Containers/G69SCX94XU.duck/Library/Application Support/duck/Volumes.noindex`.
:::
